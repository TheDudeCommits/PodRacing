...
try {
  ...
  const receipt=await page.evaluate(async()=>await(await import('/assets/source/inkstorm/launch-surface-join-round31/gpu-sampler-diagnostic.ts')).runGpuSamplerDiagnostic());
