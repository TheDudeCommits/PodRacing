...
export default defineConfig({
  ...
  test: {
    ...
    include: [`${project}/tests/combat/TeemtoStrikeMotion.test.ts`, `${preparation}/candidate/tests/combat/TeemtoAuthoredDamage.test.ts`, `${project}/tests/combat/TeemtoGroundFootprint.test.ts`, `${project}/tests/combat/TeemtoGroundEdges.test.ts`, `${project}/tests/combat/WreckVisualPose.test.ts`],
  },
});
