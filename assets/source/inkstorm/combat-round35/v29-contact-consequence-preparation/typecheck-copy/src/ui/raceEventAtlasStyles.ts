...
.race-event-atlas {
 ...
 background-image:url("data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%22192%22%20height%3D%22192%22%3E%3Cfilter%20id%3D%22paper%22%3E%3CfeTurbulence%20type%3D%22fractalNoise%22%20baseFrequency%3D%22.78%22%20numOctaves%3D%223%22%20stitchTiles%3D%22stitch%22%20seed%3D%2217%22%2F%3E%3CfeColorMatrix%20type%3D%22matrix%22%20values%3D%220%200%200%200%20.10%200%200%200%200%20.15%200%200%200%200%20.16%200%200%200%20.09%200%22%2F%3E%3C%2Ffilter%3E%3Cpath%20fill%3D%22%23fff%22%20filter%3D%22url%28%23paper%29%22%20d%3D%22M0%200h192v192H0z%22%2F%3E%3C%2Fsvg%3E"); background-size:192px 192px;
...
.race-event-atlas__band { position:relative; height:52px; min-height:52px; margin-bottom:32px; background:linear-gradient(90deg,#244249 0 70%,#41666c 70%); }
.race-event-atlas__band::after { content:''; position:absolute; top:59px; left:0; right:0; height:23px; background:#a7b6aa; border-bottom:3px solid var(--atlas-petrol); }
...
.race-event-atlas__map { position:relative; width:100%; min-width:1000px; height:clamp(420px,calc(100dvh - 380px),640px); }
...
.race-event-atlas__orbits g { vector-effect:non-scaling-stroke; }
.race-event-atlas__orbits path,.race-event-atlas__orbits ellipse { vector-effect:non-scaling-stroke; }
.race-event-atlas__orbits .atlas-orbit-main { stroke-width:1.75; opacity:.85; }
.race-event-atlas__orbits .atlas-orbit-secondary { stroke-width:1.15; opacity:.65; }
.race-event-atlas__orbits .atlas-orbit-fine { stroke-width:.8; opacity:.55; }
.race-event-atlas__orbits .atlas-orbit-accent { stroke:var(--atlas-red); stroke-width:3; opacity:.8; }
...
.race-event-atlas__disc::after { content:""; position:absolute; inset:0; border-radius:50%; pointer-events:none; opacity:.18; background:repeating-linear-gradient(0deg,transparent 0 1.4px,#d9ddc0 1.4px 1.7px,transparent 1.7px 2.4px); mix-blend-mode:soft-light; }
