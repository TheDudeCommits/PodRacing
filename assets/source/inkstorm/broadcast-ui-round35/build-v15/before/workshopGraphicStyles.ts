...
.pod-hud__workshop-slots,.pod-hud__workshop-parts,.pod-hud__workshop-summary { border-radius:3px; background:var(--equipment-ink); }
...
.pod-hud__workshop-parts::before,.pod-hud__workshop-slots::before,.pod-hud__workshop-summary strong {
 color:#bed0b7; font:700 13px/1.2 Inkstorm UI,sans-serif; letter-spacing:.09em;
 border-bottom:1px solid #bed0b766; padding-bottom:10px; margin-bottom:4px;
}
.pod-hud__workshop-slots::before { content:'INSTALLED'; }
.pod-hud__workshop-parts::before { content:'AVAILABLE PARTS'; }
.pod-hud__workshop-slots,.pod-hud__workshop-parts { scroll-padding-top:42px; }
...
.pod-hud__workshop .pod-hud__workshop-slot {
 min-height:80px; padding:12px 10px 12px 76px; border:0!important; border-radius:2px;
...
.pod-hud__workshop-slot>span { color:inherit; font-size:10px; font-weight:700; letter-spacing:.12em; }
.pod-hud__workshop-slot>strong { color:inherit; font:700 15px/1.15 Inkstorm UI,sans-serif; white-space:normal; overflow:visible; overflow-wrap:anywhere; }
...
.pod-hud__workshop .pod-hud__workshop-part {
 ...
 min-height:280px; gap:5px; padding:16px!important;
 border:0!important; border-radius:3px; background:#2b4a50!important;
 color:var(--equipment-paper); box-shadow:none;
}
.pod-hud__workshop-part>.pod-hud__component-symbol { width:78px; height:78px; align-self:flex-start; margin-bottom:3px; }
.pod-hud__workshop-part>strong { color:inherit; font:700 19px/1.1 Inkstorm UI,sans-serif; letter-spacing:-.015em; overflow-wrap:anywhere; min-height:2.2em; align-self:stretch; }
.pod-hud__workshop-part>p { order:4; color:#e2e6d6; font:400 14px/1.4 Inkstorm UI,sans-serif; }
.pod-hud__workshop-part>.is-benefit,.pod-hud__workshop-part>.is-tradeoff { font:700 14px/1.35 Inkstorm UI,sans-serif; min-height:2.7em; }
...
.pod-hud__workshop-part>.pod-hud__equip-action {
 order:6; align-self:stretch; display:block; margin-top:auto; padding-top:9px; border-top:0;
 color:var(--equipment-paper); font:700 12px/1.25 Inkstorm UI,sans-serif; letter-spacing:.07em;
}
.pod-hud__workshop-part .pod-hud__part-comparison { order:5; font-size:13px; line-height:1.4; white-space:normal; }
...
.pod-hud__workshop-part.is-equipped>strong { grid-column:2; grid-row:1; min-height:0; font:700 26px/1.05 Inkstorm UI,sans-serif; align-self:start; }
.pod-hud__workshop-part.is-equipped>p,.pod-hud__workshop-part.is-equipped>span { grid-column:2; color:var(--equipment-ink); }
.pod-hud__workshop-part.is-equipped>.is-benefit { grid-row:2; min-height:0; font-size:16px; }
.pod-hud__workshop-part.is-equipped>.is-tradeoff { grid-row:3; min-height:0; color:#803221; font-size:16px; }
.pod-hud__workshop-part.is-equipped>.pod-hud__equip-action { grid-column:2; grid-row:4; align-self:start; margin:0; padding:5px 0 0; color:var(--equipment-rust); border:0; }
.pod-hud__workshop .pod-hud__workshop-part.is-equipped>p { display:block; grid-column:1/-1; grid-row:5; font-size:14px; text-transform:none; }
...
.pod-hud__workshop-summary { display:flex; flex-direction:column; gap:17px; padding:15px; }
.pod-hud__workshop-summary>div,.pod-hud__workshop-summary>details { flex:0 0 auto; padding:0; overflow:visible; }
.pod-hud__workshop-effective ul { grid-template-columns:repeat(2,minmax(0,1fr)); gap:8px 16px; margin-top:10px; }
.pod-hud__workshop-summary .pod-hud__workshop-effective li {
 grid-template-columns:minmax(0,1fr); gap:2px; padding:0; border:0;
 white-space:normal; overflow:visible; font:700 12px/1.2 Inkstorm UI,sans-serif;
}
...
.pod-hud__workshop-summary li { white-space:normal; overflow:visible; text-overflow:clip; font-size:13px; line-height:1.4; }
.pod-hud__workshop-contributors>summary { padding:0; color:#c7d5c7; font:700 12px/1.3 Inkstorm UI,sans-serif; cursor:pointer; }
.pod-hud__workshop-contributors[open]>strong { margin-top:14px; font-size:12px; }
...
@media (min-width:1101px) {
 .pod-hud__workshop .pod-hud__workshop-slot { min-height:80px; padding-top:10px; padding-bottom:10px; }
}
...
@media (min-width:1280px) {
 .pod-hud__workshop-parts { grid-template-columns:repeat(3,minmax(0,1fr)); gap:12px; }
...
@media (max-width:760px) {
 ...
 .pod-hud__workshop .pod-hud__workshop-part { min-height:0; }
