...
export const POD_IDENTITIES: Readonly<Record<PodIdentityId, PodIdentity>> = Object.freeze({
  teemto: Object.freeze({
    id: 'teemto', label: 'Kestrel', role: 'balanced', roleLabel: 'Balanced racer',
    tagline: 'Twin ducted turbines and swept fins. Honest, forgiving and quick everywhere: the craft to learn a lap in.',
    bestOn: 'Any circuit',
  ...
  sebulba: Object.freeze({
    id: 'sebulba', label: 'Scrapjack', role: 'fast', roleLabel: 'Fast, heat-sensitive',
    tagline: 'Two mismatched salvage engines bolted to a flame jet. The highest top speed and the hungriest boost; ration the heat.',
    bestOn: 'Long straights and the Colossus run',
  ...
  polwo: Object.freeze({
    id: 'polwo', label: 'Hornet', role: 'agile', roleLabel: 'Agile specialist',
    tagline: 'Four small engines and a needle cockpit. Eager to turn with the strongest drift charge; hates hard landings.',
  ...
  blockrunner: Object.freeze({
    id: 'blockrunner', label: 'Bulwark', role: 'heavy', roleLabel: 'Heavy bruiser',
    tagline: 'Armour plate, ram grilles and a roll cage. Slow to turn, hard to move, shrugs off contact and heat.',
  ...
  verdigris: Object.freeze({id: 'verdigris', label: 'Sirocco', role: 'balanced', roleLabel: 'Endurance racer',
    tagline: 'Three canvas-wrapped brass engines built for long hauls. Cool-running, predictable grip, patient launch.', bestOn: 'Ember Rift and long races',
  ...
  skybolt: Object.freeze({id: 'skybolt', label: 'Longshot', role: 'fast', roleLabel: 'Sprint specialist',
    tagline: 'Needle engines as long as a runway. Quick off the line; demands careful heat management.', bestOn: 'Frostline and open straights',
  ...
  needle: Object.freeze({id: 'needle', label: 'Glasswing', role: 'agile', roleLabel: 'Precision racer',
    tagline: 'Ceramic engines with glass fins. Strong turn-in and a featherweight chassis with little protection.', bestOn: 'Verdant Run and technical routes',
  ...
  pog: Object.freeze({id: 'pog', label: 'Crucible', role: 'heavy', roleLabel: 'Compact brawler',
    tagline: 'One giant heat-stained turbine towing a bronze cockpit. Resists contact and carries a long boost.', bestOn: 'Battle and frozen traffic',
