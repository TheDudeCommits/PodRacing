...
.pod-hud__split { position:static; transform:none; font-size:13px; text-shadow:0 2px 7px #171928; }
...
.pod-hud__sector-results>span { padding:5px 8px; background:#171e3280; font-size:11px; }
.pod-hud__sector-results small { display:block; margin-bottom:4px; color:#d7cedd; font:10px/1.3 "Avenir Next",sans-serif; }
...
@media (max-width:650px) {
  ...
  .pod-hud__garage-hero { min-height:300px; flex-shrink:0; order:1; }
  .pod-hud__garage-name { left:15px; right:15px; max-width:none; }
  .pod-hud__garage-name h2 { font-size:34px; }
  .pod-hud__garage-model { left:0; right:0; top:25px; bottom:80px; }
  .pod-hud__garage-stats { padding:11px 15px; }
