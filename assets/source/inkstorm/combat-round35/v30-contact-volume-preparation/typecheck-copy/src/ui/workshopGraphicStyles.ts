...
/* Full notes use normal flow; narrow/touch layouts always show them. */
...
.pod-hud__workshop-summary { display:flex; flex-direction:column; gap:14px; padding:15px; }
.pod-hud__workshop-summary>div,.pod-hud__workshop-summary>details { flex:0 0 auto; padding:0; overflow:visible; }
.pod-hud__workshop-effective ul { grid-template-columns:minmax(0,1fr); gap:0; margin-top:10px; }
.pod-hud__workshop-summary .pod-hud__workshop-effective li {
 ...
 padding:2px 0; border:0; white-space:normal; overflow:visible; font:400 14px/1.25 Inkstorm UI,sans-serif;
}
...
.pod-hud__workshop-effective li>.pod-hud__total-group {
 grid-column:1/-1; display:block; margin:6px 0 4px; padding-top:4px; border-top:1px solid #bed0b754;
...
/* Persistent instructions explain disclosure and the native scrolling surfaces. */
.pod-hud__workshop-reading-hint { display:block; margin-top:4px; font:700 12px/1.3 Inkstorm UI,sans-serif; color:var(--equipment-ink); }
.pod-hud__workshop-reading-hint>span { display:none; }
.pod-hud__workshop,.pod-hud__workshop-parts,.pod-hud__workshop-summary {
 scrollbar-width:auto; scrollbar-color:#bacaad #203e43; scroll-padding-bottom:20px;
}
.pod-hud__workshop-parts::-webkit-scrollbar,.pod-hud__workshop-summary::-webkit-scrollbar { width:10px; height:10px; }
.pod-hud__workshop-parts::-webkit-scrollbar-thumb,.pod-hud__workshop-summary::-webkit-scrollbar-thumb { background:#bacaad; border:2px solid #203e43; border-radius:6px; }
.pod-hud__workshop-parts::-webkit-scrollbar-track,.pod-hud__workshop-summary::-webkit-scrollbar-track { background:#203e43; }
/* Desktop compares four complete benefit/tradeoff overviews before opening full prose. */
@media (min-width:1280px) and (hover:hover) and (pointer:fine) {
 .pod-hud__workshop-reading-hint>span { display:inline; }
 .pod-hud__workshop .pod-hud__workshop-part,.pod-hud__workshop .pod-hud__workshop-part.is-equipped { padding-top:12px!important; padding-bottom:12px!important; row-gap:6px; }
 .pod-hud__workshop .pod-hud__workshop-part:not(.is-equipped)>p { display:none; }
 .pod-hud__workshop .pod-hud__workshop-part:hover>p,.pod-hud__workshop .pod-hud__workshop-part:focus-visible>p { display:block; }
}
