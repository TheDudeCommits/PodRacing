...
describe('published vehicle appearance assets', () => {
  it.each(['hero', 'rival'])('matches the %s body and embedded driver contract using only its JSON header', (lod) => {
    ...
    expect(triangles).toBe(lod === 'hero' ? 57_234 : 26_180);
    if (lod === 'hero') {
      expect(createHash('sha256').update(bytes).digest('hex')).toBe('e7fe0097061d6af30a73538e10608ed8956c6565c3c9fd1fe745d8bf521c03b0');
