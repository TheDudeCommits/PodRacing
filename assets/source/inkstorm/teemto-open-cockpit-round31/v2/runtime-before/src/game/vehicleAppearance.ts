...
export type VehicleAppearanceId = 'teemto' | 'sebulba' | 'procedural';
...
export const TEEMTO_ART_DEFINITIONS: Readonly<Record<VehicleArtLod, VehicleArtDefinition>> = Object.freeze({
  hero: Object.freeze({
    id: 'teemto',
    revision: 'teemto-open-cockpit-v1',
    url: '/assets/inkstorm/vehicles/teemto-hero-open-v1.glb',
...
export function isVehicleAppearanceId(value: unknown): value is VehicleAppearanceId {
  return value === 'teemto' || value === 'sebulba' || value === 'procedural';
}
...
export function getVehicleArtDefinition(
  ...
  return id === 'sebulba' ? SEBULBA_ART_DEFINITIONS[lod] : null;
}
