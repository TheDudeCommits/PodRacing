...
const preparation = `${project}/assets/source/inkstorm/combat-round35/v24-impact-camera-preparation`;
...
export default defineConfig({
  plugins: [{
    name: 'v24-private-camera-sources', enforce: 'pre',
  ...
  test: {
    ...
    include: ['tests/camera/CinematicCamera.test.ts', 'tests/camera/GalacticCamera.test.ts', 'tests/camera/WreckBoundsFraming.test.ts'],
  },
});
