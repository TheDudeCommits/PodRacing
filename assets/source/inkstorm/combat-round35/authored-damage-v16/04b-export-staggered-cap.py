...
OUTPUT='/Users/amir/Projects/PodRacing/assets/source/inkstorm/combat-round35/authored-damage-v16/teemto-damage-b-native.glb'
snapshot=global_snapshot()
stage=None
report={'stage':'V16 geometry-only export B','path':OUTPUT,'newTextures':0,'nodes':[]}
try:
