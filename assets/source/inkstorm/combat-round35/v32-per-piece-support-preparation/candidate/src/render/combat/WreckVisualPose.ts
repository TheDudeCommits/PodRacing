...
import type { WreckGroundContact, WreckPresentationSupport } from './WreckGroundContact';
...
export interface WreckVisualPose {
  ...
  groundContacts?: readonly WreckPresentationSupport[];
