import { createCourseGulfUniforms, type CourseGulfUniforms } from '/Users/amir/Projects/PodRacing/src/render/terrain/CourseGulfTextures';
...
import { InkstormSurfaceMaterial, loadInkstormPaint } from '/Users/amir/Projects/PodRacing/src/render/inkstorm/InkstormSurfaceMaterial';
import { createInkstormRoad } from '/Users/amir/Projects/PodRacing/src/render/inkstorm/InkstormRoad';
import { createInkstormShadows } from '/Users/amir/Projects/PodRacing/src/render/inkstorm/InkstormShadows';
import { createInkstormFoundations } from '/Users/amir/Projects/PodRacing/src/render/inkstorm/InkstormFoundations';
import { createInkstormBridge } from '/Users/amir/Projects/PodRacing/src/render/inkstorm/InkstormBridge';
import { createInkstormFoundry, replacesInkstormFoundryGantry } from '/Users/amir/Projects/PodRacing/assets/source/inkstorm/round30-next-steps/typecheck/InkstormFoundry.ts';
import { createInkstormVista, type VistaLandform } from '/Users/amir/Projects/PodRacing/src/render/inkstorm/InkstormVista';
import { groundInkstormButtress } from '/Users/amir/Projects/PodRacing/src/render/inkstorm/InkstormRockGrounding';
import { InkstormTerrainShadow } from '/Users/amir/Projects/PodRacing/src/render/inkstorm/InkstormTerrainShadow';
import { CEL_TERRAIN_EDGE_SUPPRESS_USER_DATA_KEY } from '/Users/amir/Projects/PodRacing/src/render/post/CelPrepassMaterial';

import { INKSTORM_FAMILIES as families, getInkstormLayout, type InkstormFamily as Family } from '/Users/amir/Projects/PodRacing/src/game/race/inkstormLayout';
...
export class InkstormWorld extends Group {
  ...
  private async load():Promise<void>{
    ...
    const [modelResults, textureResult] = await Promise.all([
      Promise.allSettled(modelIds.map(id=>loader.loadAsync(`/assets/inkstorm/${id==='canyon-arch'?'canyon-arch-v3':id==='pit-complex'?'pit-complex-light-v1':id}.glb`))),
    ...
    for(let i=0;i<models.length;i++){
      ...
      const batch=new InstancedMesh(geometry,new InkstormSurfaceMaterial(stone, family==='pit-complex'||family==='pit-district'?family:null,
        family==='pit-complex'?{texture:this.workshopTexture,decodeRange:4,intensity:4}:null),512);
  ...
  setCourse(course:PodraceCourse):void{
    ...
    for(const p of placements){
      if(replacesInkstormFoundryGantry(course,p))continue;
