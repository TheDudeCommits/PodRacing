...
const families = {
  ...
  'pit-district': { aim:[0,-1,-.24], cuts:[-21,18], bays:[
    {p:[-36,8.08,-4], range:21, center:[-39,-2], half:[15.9,10.4], roof:8.09},
    {p:[1,13.08,-8], range:25, center:[-2,-4.5], half:[16.9,11.9], roof:13.09},
    {p:[41,9.88,-1], range:22, center:[38,1], half:[15.9,10.4], roof:9.89},
  ]},
};
...
assert((await read('InkstormSurfaceMaterial.ts.candidate')).includes(glsl),'Candidate shader matches authored GLSL exactly');
