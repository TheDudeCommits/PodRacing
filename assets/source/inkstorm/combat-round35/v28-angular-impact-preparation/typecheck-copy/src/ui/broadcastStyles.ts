...
/* Scenery remains visible between open strokes; contrast belongs to the readings. */
.pod-hud__driving-instruments .pod-hud__speed-dial { stroke-width:1.6; filter:none; }
.pod-hud__driving-instruments .pod-hud__speed-dial .dial-glass { fill:#093b4c29; stroke:none; }
.pod-hud__driving-instruments .pod-hud__speed-dial .dial-outline { fill:none; stroke:none; }
.pod-hud__driving-instruments .pod-hud__speed-dial .dial-divider { fill:none; stroke:#ffe39ba6; stroke-width:1; }
...
.pod-hud__driving-feedback { position:absolute; right:64px; bottom:294px; z-index:6; width:244px; display:flex; flex-direction:column; gap:6px; pointer-events:none; background:linear-gradient(90deg,#073b4bdf,#073b4bbf 80%,#073b4b33); box-shadow:inset 2px 0 #ffe39b99; }
.pod-hud__driving-feedback>.pod-hud__launch:not([data-stage=result]) { position:fixed; }
.pod-hud__driving-feedback>.pod-hud__launch[data-stage=result] { position:static; inset:auto; order:3; width:100%; display:none; padding:7px 9px; transform:none; background:none; border:0; border-left:2px solid transparent; clip-path:none; text-align:left; }
...
.pod-hud__driving-feedback>.pod-hud__flight { position:static; inset:auto; order:1; display:none; width:100%; min-width:0; height:auto; padding:7px 9px; transform:none; border:0; border-left:2px solid transparent; background:none; }
.pod-hud__driving-feedback>.pod-hud__flight.is-visible { display:grid; transform:none; }
...
.pod-hud__driving-feedback>.pod-hud__flight>small { margin-top:3px; text-align:left; font:700 11px/1.3 Inkstorm UI,sans-serif; letter-spacing:0; }
.pod-hud__driving-feedback>.pod-hud__meter--drift { position:static; order:2; display:none; width:100%; margin:0; padding:7px 9px; border:0; border-left:2px solid transparent; background:none; }
...
@media (max-width:760px) {
 ...
 .pod-hud__driving-feedback>.pod-hud__flight { grid-template-columns:1fr; grid-template-areas:'state' 'clear' 'motion'; gap:0; }
...
.pod-hud__threat-cue>span { flex:0 1 auto; min-width:0; width:auto; padding:3px 5px; border-radius:2px; background:#112e36df; font:700 11px/1.25 Inkstorm UI,sans-serif; letter-spacing:.025em; }
