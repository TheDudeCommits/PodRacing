...
const preparation = `${project}/assets/source/inkstorm/combat-round35/v29-contact-consequence-preparation`;
...
export default defineConfig({
  plugins: [{
    name: 'v29-private-contact-sources', enforce: 'pre',
  ...
  test: {
    ...
    include: [`${project}/tests/render/GalacticEffectsView.test.ts`, `${project}/tests/combat/WreckContactBeat.test.ts`, `${project}/tests/combat/WreckGroundContact.test.ts`, `${project}/tests/combat/AuthoredAftermath.test.ts`, `${project}/tests/render/DirectionalRuptureLifecycle.test.ts`, `${project}/tests/render/AuthoredRuptureBeat.test.ts`, `${project}/tests/render/RuptureFlameAtlas.test.ts`],
  },
});
