...
const preparation = resolve(root, 'assets/source/inkstorm/combat-round35/v24-impact-camera-preparation');
...
if (result.status === 0) console.log('Private candidate source and new actual-camera tests: TypeScript PASS.');
