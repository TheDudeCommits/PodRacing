...
const ORBITS = `<svg class="race-event-atlas__orbits" viewBox="0 0 1200 450" preserveAspectRatio="none" aria-hidden="true" focusable="false">
  <ellipse cx="665" cy="436" rx="660" ry="457" transform="rotate(-13 665 436)" class="atlas-orbit-main" vector-effect="non-scaling-stroke"/>
  <ellipse cx="412" cy="443" rx="627" ry="321" transform="rotate(19 412 443)" class="atlas-orbit-secondary" vector-effect="non-scaling-stroke"/>
  <path d="M-55 345C126 410 300 463 477 464" class="atlas-orbit-accent" vector-effect="non-scaling-stroke"/>
</svg>`;
