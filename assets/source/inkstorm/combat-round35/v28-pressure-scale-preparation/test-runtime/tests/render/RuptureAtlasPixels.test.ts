...
import { RUPTURE_FLAME_ATLAS } from '/Users/amir/Projects/PodRacing/assets/source/inkstorm/combat-round35/v28-pressure-scale-preparation/test-runtime/src/render/galactic/RuptureFlameAtlas.ts';
...
describe('actual generated PNG sampling authority', () => {
  it('isolates every meaningful alpha pixel, preserves hot witnesses and fits all artwork within the hot quads without borrowing the generic ground clamp', () => {
    ...
    for (let i = 0; i < frames.length; i++) {
      ...
      // Authored roots do not use the generic .64*3.6 birth ground clamp.
      ...
      expect(e.radius).toBeLessThan(halfX * 1.9 - 1);
    }
  });
});
