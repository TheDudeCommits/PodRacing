...
/* Open comparison rows keep each real component readable without repeated card housings. */
.pod-hud__workshop .pod-hud__workshop-part {
 display:grid; grid-template-columns:112px minmax(0,1fr); grid-auto-rows:max-content;
 align-items:start; align-self:stretch; align-content:center;
 min-height:0; gap:7px 14px; padding:12px!important;
 border:0!important; border-top:1px solid #bed0b754!important; border-left:3px solid transparent!important; border-radius:0; background:transparent!important;
 color:var(--equipment-paper); box-shadow:none;
}
.pod-hud__workshop-part>.pod-hud__component-symbol { width:80px; height:80px; grid-column:1; grid-row:1/4; align-self:center; justify-self:center; margin:0; }
.pod-hud__workshop-part>strong { grid-column:2; grid-row:1; color:inherit; font:400 20px/1.2 var(--ui-heading); letter-spacing:0; overflow-wrap:anywhere; min-height:0; align-self:start; }
.pod-hud__workshop-part>p { grid-column:1/-1; grid-row:4; color:#e2e6d6; font:400 15px/1.4 Inkstorm UI,sans-serif; }
.pod-hud__workshop-part>.is-benefit,.pod-hud__workshop-part>.is-tradeoff {
 grid-column:2; align-self:start; display:block; padding:0; border-radius:0;
 font:700 15px/1.35 Inkstorm UI,sans-serif; min-height:0; background:none;
}
.pod-hud__workshop-part>.is-benefit { grid-row:2; color:#d2e3b9; }
.pod-hud__workshop-part>.is-tradeoff { grid-row:3; color:#ffc1a0; }
.pod-hud__workshop-part>.pod-hud__equip-action {
 grid-column:1/-1; grid-row:6; align-self:stretch; display:flex; align-items:center; justify-content:space-between;
 min-height:44px; margin-top:5px; padding:11px 12px; border:0; border-radius:3px;
 background:var(--equipment-paper); color:var(--equipment-ink);
 font:400 13px/1.2 var(--ui-heading); letter-spacing:.015em;
}
.pod-hud__workshop-part .pod-hud__part-comparison { grid-column:1/-1; grid-row:5; font-size:14px; line-height:1.4; white-space:normal; }
/* An open installed specification leaves space for comparing the real alternatives. */
.pod-hud__workshop .pod-hud__workshop-part.is-equipped {
 display:grid; grid-column:1/-1; grid-template-columns:112px minmax(0,1fr); order:-1;
 min-height:0; gap:7px 14px; align-content:start; border-radius:0;
 color:var(--equipment-paper); background:transparent!important;
 border-top:0!important; border-left:3px solid var(--equipment-rust)!important; padding:12px!important; box-shadow:none;
}
.pod-hud__workshop-parts::before { order:-2; }
.pod-hud__workshop-part.is-equipped::after { content:none; }
.pod-hud__workshop-part.is-equipped>.pod-hud__component-symbol { width:112px; height:112px; grid-column:1; grid-row:1/5; align-self:center; justify-self:center; margin:0; }
.pod-hud__workshop-part.is-equipped>strong { grid-column:2; grid-row:1; min-height:0; font:400 24px/1.2 var(--ui-heading); letter-spacing:0; align-self:start; }
.pod-hud__workshop-part.is-equipped>p,.pod-hud__workshop-part.is-equipped>span { grid-column:2; color:var(--equipment-paper); }
.pod-hud__workshop-part.is-equipped>.is-benefit { grid-row:2; min-height:0; padding:0; background:none; color:#d2e3b9; font-size:17px; }
.pod-hud__workshop-part.is-equipped>.is-tradeoff { grid-row:3; min-height:0; padding:0; background:none; color:#ffc1a0; font-size:16px; }
.pod-hud__workshop-part.is-equipped>.pod-hud__equip-action { display:block; grid-column:2; grid-row:4; min-height:0; align-self:start; justify-self:start; margin:0; padding:4px 6px; color:var(--equipment-paper); background:none; border:1px solid #bed0b766; border-radius:0; font-size:12px; }
.pod-hud__workshop .pod-hud__workshop-part.is-equipped>p { display:block; grid-column:1/-1; grid-row:5; height:auto; max-height:none; overflow:visible; white-space:normal; text-overflow:clip; font-size:15px; text-transform:none; }
...
.pod-hud__workshop-part.is-equipped .pod-hud__part-comparison { grid-row:6; color:var(--equipment-paper); }
...
.pod-hud__workshop-summary .pod-hud__workshop-effective li {
 grid-template-columns:minmax(0,1fr); gap:6px; padding:0; border:0;
 white-space:normal; overflow:visible; font:700 14px/1.2 Inkstorm UI,sans-serif;
}
...
.pod-hud__workshop-summary .pod-hud__workshop-effective li>b { color:var(--equipment-paper); font:400 26px/1.1 var(--ui-heading); letter-spacing:0; font-variant-numeric:tabular-nums; }
...
/* All four wide rows share identity and modifier columns; glyph size carries selection emphasis. */
@media (min-width:1280px) {
 .pod-hud__workshop .pod-hud__workshop-part,.pod-hud__workshop .pod-hud__workshop-part.is-equipped {
  ...
  grid-template-rows:max-content max-content; align-content:start;
  min-height:0; gap:7px 12px; padding:12px!important;
 }
 .pod-hud__workshop-part>.pod-hud__component-symbol { grid-column:1; grid-row:1/3; align-self:center; justify-self:center; margin:0; }
 .pod-hud__workshop-part>strong,.pod-hud__workshop-part.is-equipped>strong { grid-column:2/4; grid-row:1; min-height:0; }
 .pod-hud__workshop-part>.is-benefit,.pod-hud__workshop-part.is-equipped>.is-benefit { grid-column:2; grid-row:2; }
 .pod-hud__workshop-part>.is-tradeoff,.pod-hud__workshop-part.is-equipped>.is-tradeoff { grid-column:3; grid-row:2; }
 .pod-hud__workshop-part>.pod-hud__equip-action,.pod-hud__workshop-part.is-equipped>.pod-hud__equip-action { grid-column:4; grid-row:1/3; margin:0; align-self:center; }
 .pod-hud__workshop-part:not(.is-equipped)>.pod-hud__equip-action { min-height:44px; padding:10px; border-radius:3px; }
 .pod-hud__workshop-part>p,.pod-hud__workshop .pod-hud__workshop-part.is-equipped>p { grid-column:1/-1; grid-row:3; }
 .pod-hud__workshop-part>.pod-hud__part-comparison,.pod-hud__workshop-part.is-equipped>.pod-hud__part-comparison { grid-column:1/-1; grid-row:4; }
 .pod-hud__workshop-part.is-equipped>.pod-hud__component-symbol { grid-row:1/3; }
}
...
@media (max-width:760px) {
 ...
 .pod-hud__workshop .pod-hud__workshop-part { grid-template-columns:96px minmax(0,1fr); min-height:0; gap:12px; }
 ...
 .pod-hud__workshop .pod-hud__workshop-part.is-equipped { grid-template-columns:96px minmax(0,1fr); gap:10px 12px; padding:12px!important; }
 .pod-hud__workshop-part.is-equipped>.pod-hud__component-symbol { width:96px; height:96px; grid-row:1; }
 .pod-hud__workshop-part.is-equipped>strong { font-size:24px; align-self:center; }
...
@media (prefers-contrast:more) {
 ...
 .pod-hud__workshop-part.is-equipped>p { color:#f2f2e4; }
}
