...
import { WreckVisualPoseCache, WRECK_PRESENTATION_DURATION, writeWreckBounds, type WreckVisualPose } from '/Users/amir/Projects/PodRacing/assets/source/inkstorm/combat-round35/v29-two-beat-camera-preparation/before-runtime/src/render/combat/WreckVisualPose.ts';

import { sampleTeemtoStrikeMotion, sampleTeemtoContactRoll, teemtoSlideTime, teemtoStrikeTime, sampleTeemtoFrontCatch, TEEMTO_FRONT_CATCH_PITCH, TEEMTO_FRONT_RESERVED_ROLL, TEEMTO_FRONT_CATCH_END } from '/Users/amir/Projects/PodRacing/src/render/combat/TeemtoStrikeMotion';
