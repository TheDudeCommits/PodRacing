...
OUTPUT = BASE / '15-author-contact-v7-composed-payload.py'
INVENTORY = BASE.parent / 'v7-contact-preparation' / 'preparation-inventory.json'
...
payload += (BASE / '15-copy-contact-color-v7.py').read_text()
...
inventory = {
 ...
 'fragments': [digest(BASE / name) for name in names + ['15-copy-contact-color-v7.py']],
