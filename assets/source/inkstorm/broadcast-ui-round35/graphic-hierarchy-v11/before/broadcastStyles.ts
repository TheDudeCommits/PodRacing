...
/* One continuous housing makes the four driving resources readable as a set. */
.pod-hud__driving-instruments { position:absolute; right:28px; bottom:20px; width:236px; height:250px; border:1px solid #f5d58e66; border-radius:40px 8px 8px 8px; background:#15343cce; color:var(--pod-paper); pointer-events:none; }
.pod-hud__driving-instruments::after { content:''; position:absolute; left:12px; right:12px; bottom:47px; height:1px; background:#f5d58e44; }
...
.pod-hud__driving-instruments .pod-hud__meter-head .pod-hud__label,.pod-hud__driving-instruments .pod-hud__meter-value { font-size:12px; }
