...
interface LaunchEscarpmentCut {
  ...
  /** Metre-scale planar talus slope: origin forward/right and gradients. */
  readonly floorPlane?: readonly [number, number, number, number];
}
...
const LAUNCH_ESCARPMENT_CUTS: Readonly<Record<string, readonly LaunchEscarpmentCut[]>> = {
  'west-basin-shelves': [
    { id: 'west-leading-talus-terrace', height: 20, feather: 42,
      floorPlane: [740,-465,.18,-.025],
      points:[[654,-625],[714,-649],[790,-614],[807,-491],
        [786,-390],[715,-342],[660,-397]],
      floorShelves:[{id:'west-middle-projecting-ledge',height:68,feather:30,
        points:[[730,-528],[778,-530],[799,-478],[767,-441],[723,-479]]}] },
    // A cross-range amphitheatre separates the tall leading tooth from the
    // farther spine. Its low sloping floor reveals the next depth layer.
    { id: 'cross-range-amphitheatre', height: 64, feather: 32,
      floorPlane: [945, -465, .13, -.035],
      points: [[896,-670],[931,-638],[982,-679],[1003,-561],
        [975,-455],[1005,-321],[941,-256],[911,-348],[890,-502]],
      floorShelves: [{ id:'amphitheatre-back-ledge', height: 100, feather: 25,
        points:[[963,-537],[1001,-508],[1005,-459],[980,-422],[954,-467]] }] },
    // Terminating side benches narrow the remaining high crest. The shared
    // central spine and its three older far-range saddles remain connected.
    { id: 'west-outer-stratified-shoulder', height: 86, feather: 34,
      floorPlane: [1050,-587,.22,-.025],
      points:[[982,-650],[1058,-672],[1121,-626],[1110,-572],[1036,-551],[995,-589]] },
    { id: 'west-inner-talus-ledge', height: 100, feather: 24,
      floorPlane: [1035,-351,.04,-.12],
      points:[[998,-359],[1030,-312],[1060,-337],[1055,-384],[1040,-407],[1006,-402]] },
  ...
  'industrial-east-ridge': [
    { id: 'inner-service-talus-bay', height: -32, feather: 42,
      floorPlane: [665,260,.11,.04],
      points:[[530,225],[625,232],[730,220],[756,265],
        [733,300],[638,281],[551,279]] },
    // Expose a lower outer shoulder between the process yard and the rear
    // refinery crown; the three founded bench cores are restored below.
    { id: 'process-outer-amphitheatre', height: 76, feather: 36,
      floorPlane: [898,548,.11,.04],
      points:[[810,510],[857,469],[927,481],[955,554],[924,646],[848,654],[817,596]],
      floorShelves:[{id:'process-rear-talus',height:112,feather:24,
        points:[[920,545],[951,554],[946,609],[920,618],[900,585]]}] },
