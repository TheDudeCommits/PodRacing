...
const receipt = {
  date: '2026-09-08', revision: 2, status: 'CANDIDATES VALIDATED; NOT PUBLISHED; NO VISUAL OR PERFORMANCE ACCEPTANCE',
  previousRevision: 'versions/v1/',
  correction: 'Reversed inward ring surfaces and cloth top/bottom, retained correct cloth edges, explicitly matched cloth-layer triangle diagonals; added six supported 24-triangle task fixtures',
