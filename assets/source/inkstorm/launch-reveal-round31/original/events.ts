...
// Physical fork crest/divergence and authored launch ridge placements alter
// racing/recovery paths. Earlier editions remain archived, never comparable ghosts.
export const MASTERY_GENERATOR_VERSION = 'inkstorm-course-8';
