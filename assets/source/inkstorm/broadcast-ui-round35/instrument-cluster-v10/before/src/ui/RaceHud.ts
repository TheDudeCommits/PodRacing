...
export class RaceHud {
  ...
  private updateWorkshop(workshop: HudWorkshopViewModel | undefined): void {
    ...
    this.workshopParts.replaceChildren(...parts.map((part) => {
      ...
      button.innerHTML = workshopSymbol(part.slot) + '<strong></strong><p></p><span class="is-benefit"></span><span class="is-tradeoff"></span><small class="pod-hud__part-comparison"></small><b class="pod-hud__equip-action"></b>';
