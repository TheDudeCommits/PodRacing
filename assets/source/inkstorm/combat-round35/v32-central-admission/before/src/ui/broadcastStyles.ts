...
/* Rim-mounted keys and joined label footings give every ability the same instrument anatomy. */
.pod-hud__combat-slot { background:none; border:0; border-radius:0; box-shadow:none; overflow:visible; }
.pod-hud__combat-key { top:0; left:0; width:22px; height:22px; padding:0; border:1px solid #ffe39bc9; border-radius:50%; background:#093b4c; box-shadow:none; color:#ffe39b; font:700 13px/1 Inkstorm UI,sans-serif; transform:none; }
.pod-hud__system-gauge { z-index:1; left:50%; top:5px; width:48px; height:48px; background:conic-gradient(var(--pod-system-accent) 0 var(--pod-readiness-angle),#17363eb8 var(--pod-readiness-angle) 360deg); transform:translateX(-50%) rotate(-35deg); }
.pod-hud__system-gauge::before { inset:3px; background:#093b4cd9; box-shadow:none; }
.pod-hud__system-icon { inset:10px; }
.pod-hud__combat-slot--weapon .pod-hud__system-icon::before { left:0; top:30%; width:80%; height:12%; box-shadow:0 6px 0 var(--pod-paper); }
.pod-hud__combat-slot--weapon .pod-hud__system-icon::after { left:73%; top:19%; width:24%; height:39%; }
.pod-hud__combat-slot::after { content:""; position:absolute; left:12%; right:12%; top:43px; bottom:6px; z-index:0; background:#093b4cd9; border-bottom:1px solid #ffe39b99; border-radius:0 0 12px 12px; clip-path:polygon(16% 0,84% 0,100% 100%,0 100%); pointer-events:none; }
.pod-hud__system-label { left:50%; right:auto; bottom:6px; width:max-content; max-width:100%; padding:2px 4px; border-radius:0 0 8px 8px; background:#093b4cd9; overflow:visible; text-overflow:clip; color:#ffe39b; font:700 12px/1.2 Inkstorm UI,sans-serif; text-shadow:none; transform:translateX(-50%); }
.pod-hud__system-ammo { z-index:2; right:0; bottom:30px; color:#ffe39b; font:700 13px/1 Inkstorm UI,sans-serif; text-shadow:0 1px 0 #112e36; }
.pod-hud__galactic.is-shield-active .pod-hud__combat-slot--shield { background:none; }
.pod-hud__galactic.is-shield-active .pod-hud__combat-slot--shield .pod-hud__system-gauge { box-shadow:0 0 0 3px #bce5b955; }
...
.pod-hud.is-high-contrast .pod-hud__system-gauge::before,.pod-hud.is-high-contrast .pod-hud__combat-slot::after,.pod-hud.is-high-contrast .pod-hud__system-label,.pod-hud.is-high-contrast .pod-hud__combat-key { background:#0b2026; }
@media (max-width:760px) {
