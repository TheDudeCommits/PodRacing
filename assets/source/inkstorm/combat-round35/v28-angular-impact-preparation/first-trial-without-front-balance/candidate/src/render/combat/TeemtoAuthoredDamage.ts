...
import { sampleTeemtoStrikeMotion, sampleTeemtoContactRoll, teemtoSlideTime, teemtoStrikeTime, sampleTeemtoFrontCatch, TEEMTO_FRONT_CATCH_PITCH, TEEMTO_FRONT_RESERVED_ROLL } from './TeemtoStrikeMotion';
