...
STAGE='PodRacing — Teemto damage V16 pinned intact rival source'
SOURCE='/Users/amir/Projects/PodRacing/assets/source/inkstorm/combat-round35/authored-damage-v16/intact-teemto-rival.glb'
...
stage=None
success=False
report={'stage':'V16 pinned source import','source':SOURCE,'sourceByteSha256External':'3d9d8d8d924258b84553de7f31f44dc4f69f069511cb6358ab2c174768e3385f'}
try:
    ...
    assert len(stage.objects)==11
    meshes=[o for o in stage.objects if o.type=='MESH']
    assert len(meshes)==7
    assert sum(len(o.data.polygons) for o in meshes)==26180
    lineage=[]
    for ob in list(stage.objects):
        original=ob.name
        ob.name='Teemto V16 rival intact | '+original
