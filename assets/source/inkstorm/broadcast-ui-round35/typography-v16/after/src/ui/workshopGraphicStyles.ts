...
.pod-hud__workshop-part>strong { color:inherit; font:400 clamp(19px,1.55vw,22px)/1.16 var(--ui-heading); letter-spacing:0; overflow-wrap:anywhere; min-height:2.12em; align-self:stretch; }
...
.pod-hud__workshop .pod-hud__workshop-part.is-equipped {
 display:grid; grid-column:1/-1; grid-template-columns:100px minmax(0,1fr);
...
.pod-hud__workshop-part.is-equipped>.pod-hud__component-symbol { width:96px; height:96px; grid-column:1; grid-row:1/5; align-self:center; margin:0; }
...
@media (min-width:1280px) {
 .pod-hud__workshop-parts {
  ...
  grid-template-rows:max-content max-content; grid-auto-rows:minmax(max-content,1fr);
  align-content:stretch; gap:10px;
 }
 .pod-hud__workshop-parts::before { order:-2; }
 .pod-hud__workshop .pod-hud__workshop-part:not(.is-equipped) {
  display:grid; grid-template-columns:58px minmax(0,1fr) minmax(0,1fr) 124px;
  grid-template-rows:max-content max-content; align-content:center;
  min-height:110px; gap:7px 12px; padding:12px!important;
  border-radius:5px; border-left:3px solid #b7c9b254!important;
 }
 .pod-hud__workshop-part:not(.is-equipped)>.pod-hud__component-symbol { grid-column:1; grid-row:1/3; width:58px; height:58px; align-self:center; margin:0; }
