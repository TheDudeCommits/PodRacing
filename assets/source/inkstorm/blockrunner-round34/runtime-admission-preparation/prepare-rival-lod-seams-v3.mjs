 ...
 * V3 reduced attribute-weight experiment; no geometry update/reprojection or public writes. */
...
// Absolute geometric error cap 2 cm, normal weight .05 m, UV weight .3 m.
const [simplified,error]=MeshoptSimplifier.simplifyWithAttributes(indices,positions,3,attributes,5,[.05,.05,.05,.3,.3],locks,24000*3,.02,['LockBorder','ErrorAbsolute','Permissive']);
