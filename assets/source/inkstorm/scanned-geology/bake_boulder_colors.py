...
def color(value,ao):
    t=clamp(value*.84+.16)
    if t<.40:c=mix((.15,.07,.12),(.57,.23,.13),t/.40)
    elif t<.75:c=mix((.57,.23,.13),(.82,.39,.18),(t-.40)/.35)
    else:c=mix((.82,.39,.18),(.96,.68,.38),(t-.75)/.25)
    return mix(c,(.105,.055,.12),clamp((1-ao)*1.45)*.27)
