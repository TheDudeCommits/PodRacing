...
for (const [name, directory] of [['rejected-v2', path.join(stage, 'versions/v2-blocked-fixtures')], ['current-v3', stage]]) {
  ...
  assert.equal(clear, name === 'current-v3' ? 9 : 0, name + ': engine/bench/aisle paths');
