 ...
 * V2 attribute-seam-aware experiment; no geometry update/reprojection or public writes. */
...
const [simplified,error]=MeshoptSimplifier.simplifyWithAttributes(indices,positions,3,attributes,5,[.15,.15,.15,3,3],locks,24000*3,.02,['LockBorder','ErrorAbsolute','Permissive']);
