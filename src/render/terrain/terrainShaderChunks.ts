...
void main() {
  ...
  vec3 fields;
  float terrainHeight = terrainFields(logicalXZ, fields);
  vec3 unusedFields;
  ...
  float heightX = terrainFields(logicalXZ + vec2(normalEpsilon, 0.0), unusedFields);
  float heightZ = terrainFields(logicalXZ + vec2(0.0, normalEpsilon), unusedFields);
