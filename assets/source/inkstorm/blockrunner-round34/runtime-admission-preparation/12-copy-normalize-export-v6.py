...
try:
    ...
    assert paint_atlas_graphs_before == BLOCKRUNNER_PAINT_STATE['atlasGraphSignatures'], 'V6 atlas shader properties differ from actual receipt.'
    assert paint_packed_images_before == BLOCKRUNNER_PAINT_STATE['atlasPackedImageRecords'], 'V6 packed atlas bytes/state differ from actual receipt.'
