...
const preparation = `${project}/assets/source/inkstorm/combat-round35/v31-contact-billow-preparation`;
...
export default defineConfig({
  plugins: [{
    name: 'v31-private-contact-billows', enforce: 'pre',
  ...
  test: {
    ...
    include: [`${preparation}/candidate/tests/**/*.test.ts`,
      ...
      `${project}/tests/combat/WreckGroundContact.test.ts`,
