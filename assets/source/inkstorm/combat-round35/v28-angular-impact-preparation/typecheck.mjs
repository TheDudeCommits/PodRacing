...
const preparation = resolve(root, 'assets/source/inkstorm/combat-round35/v28-angular-impact-preparation');
...
if (result.status === 0) console.log('Private candidate source and support-pivot tests: TypeScript PASS.');
