...
export class VehicleCardPreviewRenderer {
  ...
  private renderVehicle(
    ...
    cameraDirection.set(0.7, 0.38, -1).normalize().applyAxisAngle(worldUp, angle * Math.PI / 180);
    ...
    vehicle.update({ x: 0, y: 0, z: 0, yaw: -.18, pitch: .025, roll: 0,
      steer: .12, throttle: .7, speed: 126, boost: .12, damage: 0 }, 1.75 + vehicle.racerIndex * .31);
