...
SOURCE_STAGE = 'PodRacing — Foundry service gantry round33 V1'
REVIEW_STAGE = 'PodRacing — Foundry service gantry round33 technical V1'
FAMILY = 'foundry-service-gantry-v1'
OUT = '/Users/amir/Projects/PodRacing/assets/source/inkstorm/foundry-service-round33/v1/'
EXPECTED_SOURCE_SHA256 = '3d0cd999daf52b82ac0232c7316a5e4072c80bd83982f83cbaf4a1dcde11e862'
...
def execute_export_and_review():
    ...
    assert source.get('retainedTriangles')==3940 and source.get('removedSignalTriangles')==2360
    assert source.get('supportsAndFootprintsUnchanged') is True
    assert source.get('localCorridorClearanceZ',0)>=39.60
    ...
    assert len(source.data.loop_triangles)==6500 and source.get('candidateTriangles')==6500
    ...
    report = {'sourceScene':SOURCE_STAGE,'scope':'Neutral source construction inspection; not gameplay, art acceptance or FPS evidence.',
              ...
              'sourceGeometryDraws':1,'sourceMaterialSlots':1,'sourceImages':0,'sourceTriangles':6500,
    ...
    try:
        ...
        assert abs(low.z+25)<2e-4 and abs(high.z-61.45)<2e-4
