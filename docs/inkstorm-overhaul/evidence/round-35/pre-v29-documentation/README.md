> **Current local development: Round 35 / V28 (9 September 2026).** Verified native and measured checkpoint; final visual/fleet overhaul remains unfinished. [Detailed checkpoint](docs/inkstorm-overhaul/ROUND35_UI_COMBAT_HANDOVER.md) · [Actual V28 gallery](docs/inkstorm-overhaul/CURRENT_VISUALS.md).
...
The [complete V27 README front matter](docs/inkstorm-overhaul/evidence/round-35/pre-v28-documentation/README.md) is retained. The older product descriptions below are historical.

# Now This Is PodRacing — local Inkstorm overhaul

**The local overhaul remains incomplete, art is unaccepted, and no overhaul commit/push/deployment has occurred.** V8 contact-color source bakes, packages and local admission are complete; the fresh paired review finds all four comparisons tied, with both versions **5.5/10 overall vehicle, FAIL against 8/10**. No quality improvement is demonstrated.

V8 passes 671 tests/120 executed files and image/UI checks. Its healthy instrumented resource run is non-reproduction only. The earlier V5 races/staged/context PASS and uninstrumented **+1 geometry/+2 textures resource FAIL** remain historical evidence. V9 Sobel is retained after a fresh paired review: salt/launch preferred, grid/Foundry exit tied, subtle improvement with broader in-game/world 6/10 FAIL8; no resource/performance acceptance.

Start with [HANDOVER](HANDOVER.md), [STATUS](docs/inkstorm-overhaul/STATUS.md), [ROUND34](docs/inkstorm-overhaul/ROUND34.md), [images/reviews](docs/inkstorm-overhaul/CURRENT_VISUALS.md) and [catalogue/licences](docs/inkstorm-overhaul/VEHICLE_CATALOG.md). Four registered art families are separate from four driving classes. Results belong to their exact inputs. [Audited paired review](assets/source/inkstorm/blockrunner-round34/contact-color-v1-blind-review/audited-review-v1.json) · [V5 technical record](docs/inkstorm-overhaul/FULL_RACE_PERFORMANCE_BLOCKRUNNER_V5_ROUND34.md) · [V8 diagnostic](output/playwright/round34-blockrunner-contact-color-v8-resource-owner-attempt1/ANALYSIS-v1.md).

The earlier product README below is historical and remains verbatim. [Complete immediate pre-V8 README](docs/inkstorm-overhaul/evidence/round-34/pre-contact-color-v8-documentation/README.md).

[V9 current review](assets/source/inkstorm/round34-distant-edge-diagnosis/blind-runtime-v9/cli-critic-attempt1/review.md).

## Archived pre-overhaul product README — preserved verbatim
