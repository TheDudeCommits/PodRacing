# PodRacing handover — 9 September 2026, Round 35 / V28
...
Use [Round 35 implementation and current QA](docs/inkstorm-overhaul/ROUND35_UI_COMBAT_HANDOVER.md) and [current actual gallery](docs/inkstorm-overhaul/CURRENT_VISUALS.md) as the front doors. The [complete pre-V28 handover](docs/inkstorm-overhaul/evidence/round-35/pre-v28-documentation/HANDOVER.md) and detailed V27 section remain preserved.
