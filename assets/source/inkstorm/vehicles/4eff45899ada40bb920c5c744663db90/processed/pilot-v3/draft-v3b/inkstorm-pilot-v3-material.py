...
ACTION = 'setup'
SOURCE = 'PodRacing — Teemto pilot construction v3b'
STAGE = 'PodRacing — Teemto pilot material v3'
EXPORT_SCENE = 'PodRacing — Teemto pilot material v3 normalized'
BASE = '/Users/amir/Projects/PodRacing/assets/source/inkstorm/vehicles/4eff45899ada40bb920c5c744663db90/processed/pilot-v3/'
REVIEW = BASE+'review/'
ATLAS_NAME = 'Inkstorm original pilot color atlas v3 2048'
...
try:
    if ACTION=='setup':
        ...
        assert sum(r['triangles'] for r in receipts)==15776
        ...
        if ACTION=='bake':
            ...
            result={'action':ACTION,'atlas':atlas.filepath_raw,'imageSize':list(atlas.size),
                'pilotTriangles':15776,'pilotDraws':6,'baseColorIncludes':'original procedural color, woven value, controlled edge wear, local AO',
