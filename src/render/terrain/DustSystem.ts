...
export class DustSystem {
  ...
  constructor(options: DustSystemOptions = {}) {
    ...
    this.wakes = new WakeRibbons(options.wakes);
    this.groundRings = new GroundDustRings(options.groundRings);
    this.crestDust = new CrestDust(options.crestDust);
    this.spray = new SandSpray(options.spray);
    this.group.add(
      this.crestDust.mesh,
