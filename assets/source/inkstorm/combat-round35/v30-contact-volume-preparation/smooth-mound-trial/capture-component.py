...
root=Path('/Users/amir/Projects/PodRacing');p=root/'assets/source/inkstorm/combat-round35/v30-contact-volume-preparation';out=root/'output/playwright/round35-combat-v30-component';out.mkdir(exist_ok=False)
