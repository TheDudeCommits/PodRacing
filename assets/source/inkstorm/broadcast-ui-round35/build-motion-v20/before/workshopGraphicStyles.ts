...
.pod-hud__workshop .pod-hud__workshop-part {
 display:grid; grid-template-columns:80px minmax(0,1fr); grid-auto-rows:max-content;
 align-items:start; align-self:stretch; align-content:center;
 min-height:0; gap:7px 14px; padding:12px!important;
 border:0!important; border-top:1px solid #bed0b754!important; border-radius:0; background:transparent!important;
 color:var(--equipment-paper); box-shadow:none;
}
.pod-hud__workshop-part>.pod-hud__component-symbol { width:80px; height:80px; grid-column:1; grid-row:1/4; align-self:center; margin:0; }
.pod-hud__workshop-part>strong { grid-column:2; grid-row:1; color:inherit; font:400 22px/1.16 var(--ui-heading); letter-spacing:0; overflow-wrap:anywhere; min-height:0; align-self:start; }
...
.pod-hud__workshop .pod-hud__workshop-part.is-equipped {
 display:grid; grid-column:1/-1; grid-template-columns:156px minmax(0,1fr); order:-1;
 min-height:236px; gap:8px 22px; align-content:center; border-radius:9px;
 color:var(--equipment-ink); background:var(--equipment-paper)!important;
 border-top:0!important; border-left:6px solid var(--equipment-rust)!important; padding:18px!important; box-shadow:none;
}
.pod-hud__workshop-parts::before { order:-2; }
.pod-hud__workshop-part.is-equipped::after { content:none; }
.pod-hud__workshop-part.is-equipped>.pod-hud__component-symbol { width:156px; height:156px; grid-column:1; grid-row:1/5; align-self:center; margin:0; }
.pod-hud__workshop-part.is-equipped>strong { grid-column:2; grid-row:1; min-height:0; font:400 26px/1.15 var(--ui-heading); letter-spacing:0; align-self:start; }
.pod-hud__workshop-part.is-equipped>p,.pod-hud__workshop-part.is-equipped>span { grid-column:2; color:var(--equipment-ink); }
.pod-hud__workshop-part.is-equipped>.is-benefit { grid-row:2; min-height:0; padding:0; background:none; font-size:19px; }
.pod-hud__workshop-part.is-equipped>.is-tradeoff { grid-row:3; min-height:0; padding:0; background:none; color:#803221; font-size:18px; }
...
.pod-hud__workshop-summary .pod-hud__workshop-effective li>b { color:var(--equipment-paper); font:400 30px/1.05 var(--ui-heading); letter-spacing:0; font-variant-numeric:tabular-nums; }
...
/* Wide equipment drawers align identity, benefit, cost, and one equip action. */
@media (min-width:1280px) {
 .pod-hud__workshop .pod-hud__workshop-part:not(.is-equipped) {
  grid-template-columns:80px minmax(0,1fr) minmax(0,1fr) 124px;
  grid-template-rows:max-content max-content; align-content:center;
  min-height:96px; gap:7px 12px; padding:8px!important;
 }
 .pod-hud__workshop-part:not(.is-equipped)>.pod-hud__component-symbol { grid-column:1; grid-row:1/3; width:80px; height:80px; align-self:center; margin:0; }
 .pod-hud__workshop-part:not(.is-equipped)>strong { grid-column:2/4; grid-row:1; min-height:0; font-size:21px; }
 .pod-hud__workshop-part:not(.is-equipped)>.is-benefit { grid-column:2; grid-row:2; }
 .pod-hud__workshop-part:not(.is-equipped)>.is-tradeoff { grid-column:3; grid-row:2; }
 .pod-hud__workshop-part:not(.is-equipped)>.is-benefit,.pod-hud__workshop-part:not(.is-equipped)>.is-tradeoff { min-height:0; padding:0; background:none; border-radius:0; font-size:15px; align-self:start; }
 .pod-hud__workshop-part:not(.is-equipped)>.pod-hud__equip-action { grid-column:4; grid-row:1/3; min-height:44px; margin:0; padding:10px; align-self:center; border-radius:3px; }
 .pod-hud__workshop-part:not(.is-equipped)>p { grid-column:2/-1; grid-row:3; }
 .pod-hud__workshop-part:not(.is-equipped)>.pod-hud__part-comparison { grid-column:2/-1; grid-row:4; }
}
...
@media (max-width:760px) {
 ...
 .pod-hud__workshop .pod-hud__workshop-part.is-equipped { grid-template-columns:112px minmax(0,1fr); gap:10px 14px; padding:14px!important; }
 .pod-hud__workshop-part.is-equipped>.pod-hud__component-symbol { width:112px; height:112px; grid-row:1; }
