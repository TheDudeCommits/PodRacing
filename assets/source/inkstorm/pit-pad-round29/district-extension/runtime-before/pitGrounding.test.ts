...
describe('pit slab foundation seating', () => {
  it('keeps the foundation top at the saved anchor after the surrounding terrain is graded', () => {
    const p: InkstormPlacement = { id: 'saved-pit', family: 'pit-complex', x: 80, z: -25,
