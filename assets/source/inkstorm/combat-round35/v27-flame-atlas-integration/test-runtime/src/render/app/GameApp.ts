import { CombatPresentationController, type CombatPresentationContext } from '/Users/amir/Projects/PodRacing/src/render/combat/CombatPresentationController';
import { WreckVisualPoseCache, type WreckVisualPose } from '/Users/amir/Projects/PodRacing/src/render/combat/WreckVisualPose';
import { WreckGroundContactGate } from '/Users/amir/Projects/PodRacing/src/render/combat/WreckGroundContact';
import {
  Color,
  Euler,
  Fog,
...
import { updateCourseJunctionFraming } from '/Users/amir/Projects/PodRacing/src/camera/CourseJunctionFraming';
import { RaceCameraDirector } from '/Users/amir/Projects/PodRacing/src/camera/RaceCameraDirector';
import { PodracerAudio, type RivalAudioTelemetry } from '/Users/amir/Projects/PodRacing/src/audio';
import { RaceMastery, masterySectorLabels, INKSTORM_HERO_SEED, type CompetitionProfile, type MasteryStartOptions } from '/Users/amir/Projects/PodRacing/src/game/mastery';
import { loadVehicleAppearance, resolveRacerAppearancePreference, saveVehicleAppearance, vehicleChaseClearance, type VehicleAppearanceId } from '/Users/amir/Projects/PodRacing/src/game/vehicleAppearance';
import { VehicleArtLibrary } from '/Users/amir/Projects/PodRacing/src/render/vehicles/VehicleArtLibrary';
import { RacerPresentation } from '/Users/amir/Projects/PodRacing/src/render/vehicles/RacerPresentation';
import { DEFAULT_PODRACER_CONFIG } from '/Users/amir/Projects/PodRacing/src/game/simulation/config';
import { InkstormWorld } from '/Users/amir/Projects/PodRacing/src/render/inkstorm/InkstormWorld';
import { InkstormGhostView } from '/Users/amir/Projects/PodRacing/src/render/inkstorm/InkstormGhostView';
import type {
  CaptureCamera,
  CapturePreset,
  ...
  ReviewCapturePreset,
  ReviewSnapshot,
} from '/Users/amir/Projects/PodRacing/src/diagnostics/reviewTypes';
import {
  PerformanceGovernor,
  type DistantRivalLod,
  type PerformanceDecision,
} from '/Users/amir/Projects/PodRacing/src/diagnostics/performance';
import {
...
} from '/Users/amir/Projects/PodRacing/src/game/input';
import {
  loadGameSettings,
  loadWorkshopGarage,
...
} from '/Users/amir/Projects/PodRacing/src/game/settings';
import {
  ...
  type PodracerEvent,
  type PodracerState,
} from '/Users/amir/Projects/PodRacing/src/game/simulation';
import {
  type AIDifficulty,
  ...
  type RaceEntryState,
  RaceSimulation,
} from '/Users/amir/Projects/PodRacing/src/game/race';
import {
  RoomSession,
  type RoomAuthoritativeEventEnvelope,
  type RoomLobbySnapshot,
  type RoomRaceStart,
} from '/Users/amir/Projects/PodRacing/src/network';
import {
  ...
  type WorkshopPartId,
} from '/Users/amir/Projects/PodRacing/src/game/galactic';
import {
  RaceHud,
  ...
  type RaceHudAction,
} from '/Users/amir/Projects/PodRacing/src/ui';
import {
  CEL_PALETTES,
  createCelMaterial,
  createInvertedHullOutline,
  type InvertedHullHandle,
} from '/Users/amir/Projects/PodRacing/src/render/materials';
import {
  CEL_TERRAIN_EDGE_SUPPRESS_USER_DATA_KEY,
  CelPostPipeline,
  CelPrepassMaterial,
} from '/Users/amir/Projects/PodRacing/src/render/post';
import { SkyAtmosphere } from '/Users/amir/Projects/PodRacing/src/render/objects/SkyAtmosphere';
import { DesertLandmarks } from '/Users/amir/Projects/PodRacing/src/render/objects/DesertLandmarks';
import {
  applyDistantRivalLodDecision,
  type PodracerMaterials,
} from '/Users/amir/Projects/PodRacing/src/render/objects/PodracerView';
import { RaceCourseView } from '/Users/amir/Projects/PodRacing/src/render/objects/RaceCourseView';
import { SpeedStreaks } from '/Users/amir/Projects/PodRacing/src/render/objects/SpeedStreaks';
import { GroundContactShadows } from '/Users/amir/Projects/PodRacing/src/render/objects/GroundContactShadows';
import { GalacticEffectsView } from '/Users/amir/Projects/PodRacing/assets/source/inkstorm/combat-round35/v27-flame-atlas-integration/test-runtime/src/render/galactic/index.ts';
import { attachPilotToAnchor, type PilotView } from '/Users/amir/Projects/PodRacing/src/render/pilots';
import { sampleTerrainHeight } from '/Users/amir/Projects/PodRacing/src/render/terrain/terrainMath';
import { TerrainSystem } from '/Users/amir/Projects/PodRacing/src/render/terrain/TerrainSystem';
import { DustSystem } from '/Users/amir/Projects/PodRacing/src/render/terrain/DustSystem';
import { TERRAIN_GLSL } from '/Users/amir/Projects/PodRacing/src/render/terrain/terrainShaderChunks';
import { createRenderer } from '/Users/amir/Projects/PodRacing/src/render/app/createRenderer';
import { InkstormSunShadow } from '/Users/amir/Projects/PodRacing/src/render/inkstorm/InkstormSunShadow';
import { InkstormRacerShadow } from '/Users/amir/Projects/PodRacing/src/render/inkstorm/InkstormRacerShadow';
import { Viewport } from '/Users/amir/Projects/PodRacing/src/render/app/Viewport';
    ...
    for (let racerIndex = 0; racerIndex < this.racerViews.length; racerIndex += 1) {
      ...
      if (!this.paused && wreckPose?.groundContact && this.wreckGroundContacts.take(
        ...
        this.galacticEffects.emitWreckGroundContact(presentationTime,
          wreckPose.groundContact.position, wreckPose.groundContact.direction, wreckPose.groundContact.footprint);
      }
