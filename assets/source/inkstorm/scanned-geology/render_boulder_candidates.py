...
try:
    ...
    targets=[('procedural-buttress-comparison','procedural-boulder-comparison'),('boulder-sandstone-1-candidate','boulder-1'),('boulder-sandstone-2-candidate','boulder-2'),('boulder-sandstone-1-lod','boulder-1-lod'),('boulder-sandstone-2-lod','boulder-2-lod')]
