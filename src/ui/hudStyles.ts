...
import { COCKPIT_CSS } from './cockpitStyles';
...
export const PODRACING_HUD_CSS = BASE_HUD_CSS + INKSTORM_HUD_CSS + BROADCAST_HUD_CSS + WORKSHOP_GRAPHIC_CSS + SIMPLE_RACE_SETUP_CSS + COCKPIT_CSS;
