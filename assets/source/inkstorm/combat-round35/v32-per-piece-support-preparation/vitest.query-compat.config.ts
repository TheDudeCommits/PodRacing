...
export default defineConfig({
  ...
  test: {
    ...
    include: [`${preparation}/candidate/tests/combat/TeemtoAuthoredDamage.test.ts`,`${preparation}/candidate/tests/combat/TeemtoSupportSettle.test.ts`,`${preparation}/candidate/tests/combat/TeemtoGroundEdges.test.ts`],
  },
});
