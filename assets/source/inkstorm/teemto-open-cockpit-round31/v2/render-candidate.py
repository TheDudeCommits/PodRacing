...
STAGE = 'PodRacing — Teemto open cockpit round31 V2 UV review'
SOURCE = '/Users/amir/Projects/PodRacing/assets/source/inkstorm/teemto-open-cockpit-round31/v2/teemto-open-cockpit-round31-v2-candidate.glb'
BASE = '/Users/amir/Projects/PodRacing/assets/source/inkstorm/teemto-open-cockpit-round31/v2/'
...
try:
    ...
    for name,eye,target,lens in [
        ...
        stage.render.filepath=BASE+'teemto-open-cockpit-round31-v2-'+name+'.png'
