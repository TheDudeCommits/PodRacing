> **Current local development: Round35 / V24b (9 September2026).** Reference-inspired UI, solo crash slow motion and pickups are implemented locally. V24b native checks and two complete M4 races pass; visual critics remain below target. Private V25 HUD/effects work is underway. [Exact checkpoint, actual images and remaining work](docs/inkstorm-overhaul/ROUND35_UI_COMBAT_HANDOVER.md). The full visual/fleet overhaul is unfinished and has not been deployed; older descriptions below are historical.
