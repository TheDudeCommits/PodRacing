> **Current local development: Round 35 / V26 (9 September 2026).** Revised Build, map, garage, HUD and crash effects pass 870 tests / 145 files, TypeScript/build, 17 native UI captures and four crash/control cases. Visual acceptance remains open; the fresh crash critic is 5/10. V26 FPS is unmeasured. [Exact checkpoint, actual images and remaining work](docs/inkstorm-overhaul/ROUND35_UI_COMBAT_HANDOVER.md). The full visual/fleet overhaul is unfinished and has not been deployed; older descriptions below are historical.
