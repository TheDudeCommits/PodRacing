...
/* A single outlined shell carries speed and the three actual resource readings. */
...
/* One backing surface: no independently filled oval or rectangular resource plate. */
.pod-hud__driving-instruments .pod-hud__speed-dial { stroke-width:1.6; filter:none; }
.pod-hud__driving-instruments .pod-hud__speed-dial .dial-glass { fill:#093b4cbf; stroke:none; }
.pod-hud__driving-instruments .pod-hud__speed-dial .dial-outline { fill:none; stroke:#ffe39bc9; }
.pod-hud__driving-instruments .pod-hud__speed-dial .dial-divider { fill:none; stroke:#ffe39b73; stroke-width:1; }
.pod-hud__driving-instruments .pod-hud__speed-dial .dial-track { stroke:#ffe39b66; stroke-width:1.6; }
...
.pod-hud__driving-instruments .pod-hud__meter-track,.pod-hud__driving-instruments .pod-hud__telemetry .pod-hud__meter-track { grid-column:2; grid-row:1; height:7px; margin:0; background:#b1d9da33; border:0; border-radius:999px; transform:none; }
...
/* One intrinsic lane puts launch causes beside driving feedback. Charging stays screen anchored. */
.pod-hud__driving-feedback { position:absolute; right:64px; bottom:294px; z-index:6; width:244px; display:flex; flex-direction:column; gap:6px; pointer-events:none; }
.pod-hud__driving-feedback>.pod-hud__launch:not([data-stage=result]) { position:fixed; }
.pod-hud__driving-feedback>.pod-hud__launch[data-stage=result] { position:static; inset:auto; order:3; width:100%; display:none; padding:7px 9px; transform:none; background:#073b4bcc; border:0; border-left:2px solid #f5d58e99; clip-path:none; text-align:left; }
...
.pod-hud__driving-feedback>.pod-hud__flight { position:static; inset:auto; order:1; display:none; width:100%; min-width:0; height:auto; padding:7px 9px; transform:none; border:0; border-left:2px solid #bce5b9; background:#073b4bcc; }
...
.pod-hud__driving-feedback>.pod-hud__meter--drift { position:static; order:2; display:none; width:100%; margin:0; padding:7px 9px; border:0; border-left:2px solid #f5d58e; background:#073b4bcc; }
