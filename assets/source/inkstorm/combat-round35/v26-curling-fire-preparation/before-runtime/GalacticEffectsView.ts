...
function createAtmosphericMaterial(): MeshBasicMaterial {
  ...
  result.onBeforeCompile = (shader) => {
    ...
    shader.fragmentShader = shader.fragmentShader.replace('#include <common>', `
      ...
      // Tapered pressure tongues share a tight root; the ends have distinct
  ...
  result.customProgramCacheKey = () => 'painterly-atmosphere-directional-rupture-v7';
  return result;
}
