...
SOURCE_STAGE = 'PodRacing — Foundry service gantry round33 V2'
REVIEW_STAGE = 'PodRacing — Foundry service gantry round33 technical V2'
FAMILY = 'foundry-service-gantry-v2'
OUT = '/Users/amir/Projects/PodRacing/assets/source/inkstorm/foundry-service-round33/v2/'
