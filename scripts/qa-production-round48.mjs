...
try {
 ...
 if(!bundles.length||bundles.some(b=>b.sha256!=='bebdf3c8d5217452bdd49f94757bec6d8e278e2b10bdb347b5cf91e07173f1fa'))throw new Error('Live bundle differs from tested expansion');
}finally{
