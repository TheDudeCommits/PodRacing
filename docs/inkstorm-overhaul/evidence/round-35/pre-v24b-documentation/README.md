> **Current local development: Round 35 (9 September 2026).** The new UI/combat implementation and exact QA are documented in [Round 35 handover](docs/inkstorm-overhaul/ROUND35_UI_COMBAT_HANDOVER.md). The full visual/fleet overhaul is unfinished and has not been deployed. Older release/checkpoint descriptions below are historical.
