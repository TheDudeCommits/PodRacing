...
export class RacerPresentation extends Group {
  ...
  get damageVariantAvailable(): boolean { return this.importedActive && this.imported.damageVariantAvailable; }
  get damageVariantActive(): boolean { return this.importedActive && this.imported.damageVariantActive; }
