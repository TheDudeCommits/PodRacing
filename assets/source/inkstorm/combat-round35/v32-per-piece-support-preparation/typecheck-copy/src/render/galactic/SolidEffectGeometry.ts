import {
  ...
  IcosahedronGeometry, LatheGeometry, PlaneGeometry, Vector2,
} from 'three';
...
/** Bottom-anchored cloud card. Porous silhouettes belong to the material;
 * this two-triangle carrier never enters opaque depth/ink prepasses. */
export function createContactDustGeometry(): BufferGeometry {
  return new PlaneGeometry(1, 1).translate(0, .5, 0);
}
